...
public class MyTinderAPI {
    ...
    private ArrayList<UserDTO> matches;
    ...
    public MainUserDTO getMainUserDTO(final String authToken) {
    ...
    public ArrayList<UserDTO> getMatches(final String authToken) {
        Log.d("MyTinderAPI", "getMatches");
        ArrayList<UserDTO> res;
...
//        res = createMockMatches();
        ...
        return new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                for (int i = 0; i < jmatches.length(); ++i) {
                    ...
                    try {
                        assert person != null;
                        user.setTinderId(person.getString("_id"));
    ...
    private static ArrayList<UserDTO> createMockMatches() {
