...
import dating_ml.ru.amur.TouristSpot;
import dating_ml.ru.amur.TouristSpotCardAdapter;
...
public class MainFragment extends AbstractTabFragment {
    ...
    private TouristSpotCardAdapter createTouristSpotCardAdapter() {
        final TouristSpotCardAdapter adapter = new TouristSpotCardAdapter(context);
